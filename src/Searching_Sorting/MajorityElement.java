...
public class MajorityElement {
    ...
    //leetcode
    //basically we are counting the number of an element and decrementing it whenever we found another element
    //for the number whose value is still highest positive is the majority
    public static int majorityEl(int[] a,int size){
        int count=0;
        int candidate=0;
